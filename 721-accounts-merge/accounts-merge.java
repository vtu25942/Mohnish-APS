...
class Solution {
    public List<List<String>> accountsMerge(List<List<String>> accounts) {
        ...
        Map<String, Integer> emails = new HashMap<>();  // email -> account ID
        Map<Integer, String> name = new HashMap<>();    // account ID -> name
        Map<String, Integer> seen = new HashMap<>();    // email -> first account ID
